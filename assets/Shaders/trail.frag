...
void main() {
    ...
    //vec2 scrollUv2 = fract(vec2(texCoord.x + g_Time * m_Speed * 1.7, texCoord.y));
    ...
    //float value = 3.0 * texColor.a * fade * fadeCoord + fadeCoord * 0.5;
    ...
    if (texCoord.y > 0.5 + fadeCoord/2 || texCoord.y < 0.5 - fadeCoord/2) {
        discard;
    }
