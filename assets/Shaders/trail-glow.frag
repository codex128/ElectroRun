...
void main() {
    ...
    //vec2 scrollUv2 = fract(vec2(texCoord.x + g_Time * m_Speed * 1.2, texCoord.y));
    ...
    float value = 3.0 * texColor.a * fadeCoord + fadeCoord * 0.5;
    if (value < m_Threshold) {
        discard;
    }
    
    gl_FragColor = mix(m_Color1, m_Color2, texColor.a);
