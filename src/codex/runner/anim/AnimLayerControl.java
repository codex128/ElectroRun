...
public class AnimLayerControl extends SubControl<AnimComposer> {
    ...
    public void enter(String layer, String action, boolean loop) {
        get(layer).enter(action, loop);
    }
    ...
    public Tween callMethod(String method, Object... arguments) {
        return Tweens.callMethod(this, method, arguments);
    }
